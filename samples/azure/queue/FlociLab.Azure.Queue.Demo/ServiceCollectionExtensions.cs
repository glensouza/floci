...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddAzureQueueDemo(this IServiceCollection services)
    {
        ...
        services.TryAddSingleton<QueueQueue>();
        ...
        // would register Queue Storage twice if a host called this method twice. TryAddEnumerable
        ...
        services.TryAddEnumerable(
            ServiceDescriptor.Singleton<IQueueCapability, QueueQueue>(
                sp => sp.GetRequiredService<QueueQueue>()));
