...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddGcpKmsDemo(this IServiceCollection services)
    {
        ArgumentNullException.ThrowIfNull(services);

        services.TryAddSingleton<KmsClientFactory>();

        // Registered by concrete type as well as by interface, because KmsPage injects KmsDemo
        ...
        // would register Cloud KMS twice if a host called this method twice. TryAddEnumerable
